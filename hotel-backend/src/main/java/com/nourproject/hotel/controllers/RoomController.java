...
@RestController
@RequestMapping("/api/public/rooms")  // Added /api for local dev, Nginx strips it in Docker
...
public class RoomController {
    ...
    @GetMapping("/number")
    public ResponseEntity<Response> getRoomNumber(){
        return ResponseEntity.ok(this.roomService.findRoomNumber());
    }
@GetMapping("/search")
