...
@RestController
@RequestMapping("/api/public/bookings")  // Added /api for local dev, Nginx strips it in Docker
...
public class BookingController {
    ...
    @PutMapping("bookingRefrence/{bookingRefrence}")
    public ResponseEntity<Response> updateBookingbyrefrence(
            @PathVariable("bookingRefrence") String bookingRefrence,
            @Valid @RequestBody BookingUpdateDto bookingUpdateDto) {
        return ResponseEntity.ok(bookingService.updateByBookingRefrence(bookingRefrence, bookingUpdateDto));
    }
