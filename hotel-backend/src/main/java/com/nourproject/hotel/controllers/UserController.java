...
@RestController
@RequestMapping("/api/public/users")  // Added /api for local dev, Nginx strips it in Docker
...
//    @PreAuthorize("hasRole('ADMIN')")
  ...
  return ResponseEntity.ok(this.userService.findByEmail(email));
    ...
    public ResponseEntity<Response> updateUserByEmail(@PathVariable("email") String email, @RequestBody UserUpdateDto userUpdateDataDto) {
