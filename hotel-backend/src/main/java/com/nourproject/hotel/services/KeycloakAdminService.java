...
public class KeycloakAdminService {
     ...
     * This method is used for initial sync to ensure all Keycloak users exist in the database
     * 
    ...
    public List<UserRepresentation> getAllKeycloakUsers() {
        try {
            ...
            System.out.println("Retrieved " + users.size() + " users from Keycloak");
            return users;
            
        } catch (Exception e) {
            System.err.println("Failed to retrieve users from Keycloak: " + e.getMessage());
            e.printStackTrace();
    ...
    /**
     * Gets the realm roles for a specific user
     * 
    ...
    public List<String> getUserRealmRoles(String userId) {
        try {
            ...
            System.err.println("Failed to get user roles for user ID: " + userId + ", Error: " + e.getMessage());
            return List.of();
        }
    }
